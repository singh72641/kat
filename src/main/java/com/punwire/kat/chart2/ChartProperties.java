...
import com.punwire.kat.core.XMLUtil;
 ...
 */
public class ChartProperties implements XMLUtil.XMLTemplate {
    ...
    public static final double BAR_WIDTH = 28;
    ...
    public static final Color GRID_HORIZONTAL_COLOR =  new Color(80,80,80);
    public static final int GRID_HORIZONTAL_STROKE_INDEX = 0;
    public static final boolean GRID_HORIZONTAL_VISIBILITY = true;
    public static final Color GRID_VERTICAL_COLOR =  new Color(80,80,80);
    public static final int GRID_VERTICAL_STROKE_INDEX = 0;
    public static final boolean GRID_VERTICAL_VISIBILITY = true;

    public static final Color BACKGROUND_COLOR = new Color(50, 50, 50);// new Color(0xffffff);
    public static final Font FONT = new Font("Dialog", Font.PLAIN, 24);
    public static final Color FONT_COLOR =  Color.white;// new Color(0x2e3436);
