...
import com.punwire.kat.core.ProxyManager;
...
public class Yahoo extends DataProvider
{
    ...
    {
        return ResBundle.getMessage("Stock_URL", URLEncoder.encode(symbol, "UTF-8"));
    }
            ...
            throws UnsupportedEncodingException
    {
        ...
        return ResBundle.getMessage("Data_URL", new String[]
                {
    ...
    private String getLastDataURL(Stock stock)
            throws UnsupportedEncodingException
    {
        return ResBundle.getMessage("LastData_URL", URLEncoder.encode(stock.getKey(), "UTF-8"));
    }

    @Override
    public List<Stock> fetchAutocomplete(String text)
            throws IOException
    {
