...
public class DataItem implements Serializable, Comparable<DataItem> {
    ...
    public DataItem(long time, double open, double high, double low, double close, double volume, double openInt) {
        this.time = time;
        this.open = open;
        this.high = high;
        this.low = low;
    ...
    public boolean equals(Object obj) {
        ...
        if (getOpenInterest() != that.getOpenInterest())
            return false;
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + (int) (Double.doubleToLongBits(this.openInterest) ^ (Double.doubleToLongBits(this.openInterest) >>> 32));
        return hash;
    }
    ...
    public String toString() {
        ...
        //sb.append(", volume=");
        sb.append(Double.toString(volume)).append(",");
        //sb.append(", openint=");
        sb.append(Double.toString(openInterest));
        //sb.append(", time=");
        return sb.toString();
    }
