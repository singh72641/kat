...
//    public int openAnalysis(String analysisFileName) {
//        Variant vResult = Dispatch.call(dAmiBroker, "AnalysisDocs",
//                new Variant(type),
//                new Variant(importFileName),
//                new Variant(formatFileName));
//        return vResult.getInt();
//    }
    ...
    public Documents getDocuments() {
        Dispatch vResult =  dAmiBroker.getProperty("Documents").toDispatch();
        Dispatch vDoc =  dAmiBroker.getProperty("ActiveDocument").toDispatch();
        Documents docs = new Documents(vResult);
        docs.setActiveDocument(vDoc);
        return docs;
    }
    ...
    public AnalysisDocs getAnalysisDocs() {
        Dispatch dAnalysisDocs  = dAmiBroker.getProperty("AnalysisDocs").toDispatch();
        return new AnalysisDocs(dAnalysisDocs);
    }
    ...
    public class Documents {
        private Dispatch dDocuments;
        private Document activeDocument;
        private Documents(Dispatch dDocuments) {
            this.dDocuments = dDocuments;
        }
        ...
        public void setActiveDocument(Dispatch vDoc) {
            this.activeDocument = new Document(vDoc);
        }

        public Document open(String symbol)
        {
            Variant vResult = Dispatch.call(dDocuments, "Open",
                    new Variant(symbol));
            return !vResult.isNull() ? new Document(vResult.toDispatch()) : null;
        }

        public class Document {
            private Dispatch dDocument;

            private Document(Dispatch dDocument) {
                this.dDocument = dDocument;
            }

            public String getName() {
                Variant vResult = Dispatch.get(dDocument, "Name");
                return vResult.getString();
            }
        ...
        public Document getDocument(Dispatch doc){
